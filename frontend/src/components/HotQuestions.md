...
### 排名徽章(金色系统一色系)
- **Top1**: 高饱和金色 `#FFD700 → #FFA500` (44×44rpx, 字重800, 更强阴影)
- **Top2**: 中等金色 `#E6C200 → #D4A017` (40×40rpx, 字重700)
- **Top3**: 暗金色 `#C9A003 → #B8860B` (40×40rpx, 字重700)
- **Top4-5**: 浅灰弱化 `$gray-100` (40×40rpx, 字重600, 浅色文字)

**设计理念**:Top1-3 采用金色系不同明度,形成清晰的"金银铜"视觉层级,避免色彩跳跃。

### 标题层级
- **Top1**: 字号 28rpx, 字重 600, 行高 1.5(头条感)
- **Top2-3**: 字号 26rpx, 字重 500, 行高 1.4
- **Top4-5**: 字号 26rpx, 字重 400, 颜色 `$gray-700`(弱化)

### 热度可视化(克制设计)
- 浏览量下方显示 2.5rpx 高度轻量渐变条
- **起点优化**:从图标右侧(28rpx)开始,避免"横线扎堆"感
- 宽度基于浏览量百分比动态计算(最小 5%)
- Hover 时高度增至 3.5rpx,颜色更饱满
- Top4-5 热度条降低透明度至 60%
...
### v1.2.0 (2025-01-XX) - 克制打磨版(专业评审后微调)
- 🎨 **色彩统一**:Top1-3 采用金色系不同明度(100%/70%/50%),避免色彩跳跃
- 🎨 **头条强化**:Top1 标题字号微调(26rpx→28rpx),字重600,行高1.5
- 🎨 **热度条克制**:起点从图标右侧(28rpx)开始,高度降低(2.5rpx),避免"横线扎堆"
- 🎨 **层级弱化**:Top4-5 热度条透明度降至60%,进一步减少视觉噪音
...
**设计理念**:
> v1.1 基于专业 UX 评审反馈,强化热度感知和视觉节奏,从 80 分提升到 85 分。
> v1.2 克制打磨,解决色彩跳跃、热度条扎堆、头条感不足三大问题,达到"成熟社区产品可上线水准"。

**核心原则**:
- ✅ 金色系统一 Top1-3,逻辑清晰
- ✅ 热度条轻量化,避免视觉噪音
- ✅ Top1 头条感适度强化,不破坏整体克制
- ✅ 保持"辅助内容"定位,不抢主内容视觉权重
