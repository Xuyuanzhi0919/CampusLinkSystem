...
![图5-6 系统首页运行效果（桌面端）](pictures/desktop-home.png)
...
![图5-7 资源共享模块运行效果（桌面端）](pictures/desktop-resource.png)
...
![图5-8 问答社区模块运行效果（桌面端）](pictures/desktop-question.png)
...
![图5-9 任务大厅模块运行效果（移动端）](pictures/mobile-task.png)
...
![图5-10 积分系统运行效果（移动端）](pictures/mobile-points.png)
...
![图5-11 社团活动模块运行效果（桌面端）](pictures/desktop-club.png)

**图5-11** 社团活动模块运行效果（桌面端）
...
针对各核心模块进行了系统性的功能测试，测试结果如表6-1所示。
...
使用浏览器DevTools的Network面板对主要接口进行了响应时间测量，结果如表6-2所示。
